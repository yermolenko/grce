/*
  The TensorProduct algorithm (header file).
...
#ifndef grctk_TensorProduct_hpp
#define grctk_TensorProduct_hpp
...
class TensorProduct : public Product
{
public:
  AdjMatrix operator()(const AdjMatrix&, const AdjMatrix&);
  AdjMatrix operator()(const AdjMatrix&, const AdjMatrix&,
                       Attribute<yaatk::Vector3D>& a3D);
  TensorProduct(Log& setlog = nullLog):Product(setlog) {}
};

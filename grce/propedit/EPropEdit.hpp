/*
  The EPropEdit class (header file).
...
#ifndef grce_EPropEdit_hpp
#define grce_EPropEdit_hpp
...
class EPropEdit : public Fl_Group
{
private:
  GraphEdit* sample;
...
public:
  ...
  int handle(int);
  EPropEdit(const grctk::Object);
  ~EPropEdit();

  const grctk::Object edgeSample()
    {
      return sample->graphAsAdjMatrix()(0,1);
    }
};
